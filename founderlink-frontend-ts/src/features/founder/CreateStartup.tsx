...
const CreateStartup: React.FC = () => {
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<StartupFormData>({ resolver: yupResolver(startupSchema) });
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="card">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Textarea rows={3} label="Description" placeholder="Describe your startup in a few sentences..." error={errors.description?.message} {...register('description', { required: 'Required' })} />
            ...
            <div className="flex gap-3 pt-2 border-t border-dark-500">
              <Button type="submit" variant="primary" isLoading={isSubmitting}>Create Startup</Button>
